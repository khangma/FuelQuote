...
ResultSet resultset = statement.executeQuery ("select clientname, clientstreet, clientcity, clientstate, clientzipcode, gallonsrequested, day, Month, year, total, shipping, totalcost FROM FUEL_QUOTE where username = '"+username+"'");
