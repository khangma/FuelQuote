...
<html>
   ...
   <script>
    ...
    <div id="header">
        ...
        <h2> Welcome! Update your profile </h2> </center>
        </div>
        <div id="sidemenu">
            <form action="LoginDao.java" method="post">  
            
        <div style="padding-left:350px; padding-right:350px;">
            <div class="form-group"><b>Full Name:</b><input class="form-control" type="text" name="USERNAME" required/></div>
            <div class="form-group"><b>Address 1:</b><input class="form-control" type="text" name="PASSWORD" required/></div>
            <div class="form-group"><b>Address 2:</b><input class="form-control" type="text" name="USERNAME" required/></div>
            <div class="form-group"><b>City:</b><input class="form-control" type="text" name="PASSWORD" required/></div>
            <div class="form-group"><b>State:</b><input class="form-control" type="text" name="USERNAME" required/></div>
            <div class="form-group"><b>Zipcode:</b><input class="form-control" type="text" name="PASSWORD" required/></div>

        </div><br><br>
<center><div class="form-group" style="padding-left:550px; padding-right:550px; padding-bottom: 100px"><input class="form-control" type="submit" style="background-color: green; color:white; " onclick="validateaccount()" value="SUBMIT"/></div></center>
