...
<html>
   ...
   <script>
    ...
    <div id="header">
        ...
        <h2> FUEL RATES AND DISCOUNTS </h2> </center>
        ...
        <div style="padding-left:350px; padding-right:350px;">
            <div class="form-group"><b>Summer Season Rates ($):</b><input class="form-control" type="text" name="SUMMERDISCOUNT" required/></div>
            <div class="form-group"><b>Winter Season Rates ($):</b><input class="form-control" type="text" name="WINTERDISCOUNT" required/></div>
            <div class="form-group"><b>Additional Disounts (%):</b><input class="form-control" type="text" name="DISCOUNT" required/></div>
            <div class="form-group"><b>Profit Margin (%):</b><input class="form-control" type="text" name="PROFITMARGIN" required/></div>
