...
<html>
   ...
   <script>
    ...
    <div id="header">
        ...
        <h2> TRANSPORTATION RATES </h2> </center>
        </div>
        <div id="sidemenu">
            <form action="transportationprocess.jsp" method="post">  
            
        <div style="padding-left:350px; padding-right:350px;">
            <div class="form-group"><b>Texas Shipping Cost:</b><input class="form-control" type="text" name="TXCOST" required/></div>
            <div class="form-group"><b>Other States Shipping Cost:</b><input class="form-control" type="text" name="OTHERCOST" required/></div>
...
<div class="w3-top">
  <div class="w3-bar w3-black w3-card">
    ...
    <a href="access2.jsp" class="w3-bar-item w3-button w3-padding-large">HOME</a>
